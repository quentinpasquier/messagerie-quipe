  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-white p-6 relative overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 80% 15%, rgba(60,200,121,0.10) 0%, transparent 45%), radial-gradient(circle at 15% 90%, rgba(34,25,50,0.08) 0%, transparent 50%)",
        }}
      />
      <div className="relative w-full max-w-md rounded-xl bg-white border border-gray-200 p-8 shadow-xl">
        ...
        <h1 className="text-2xl font-bold mb-1 text-gray-900">Onboarding</h1>
